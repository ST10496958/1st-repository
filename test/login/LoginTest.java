...
public class LoginTest {
    ...
    /**
     * Test of validateUserNameAndWelcome method, of class Login.
     */
    @Test
    public void testValidateUserNameAndWelcome() {
        System.out.println("validateUserNameAndWelcome");
        String userName = "";
        String firstName = "";
        String lastName = "";
        String expResult = "";
        String result = Login.validateUserNameAndWelcome(userName, firstName, lastName);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
